...
from python.Import import import_text
...
class TestEasy50(unittest.TestCase):
    ...
    def test_easy50(self):
        ...
        for puzzle_line in easy50:
            g = import_text(puzzle_line)
            puzzle = ClassicSudoku(grid=g)
            solution = puzzle.solve()
            self.assertTrue(solution['solved'])
            sum_max_degree += solution['max_degree']
            sum_analytical += solution['analytical']

        #self.assertEqual(sum_max_degree, 3)
        self.assertEqual(sum_analytical, 47)


class TestTop95(unittest.TestCase):
    ...
    def test_top95(self):
        ...
        #self.assertEqual(sum_max_degree, 397)
        self.assertEqual(sum_analytical, 14)


class TestHardest(unittest.TestCase):
    ...
    def test_hardest(self):
        ...
        #self.assertEqual(sum_max_degree, 32)
        self.assertEqual(sum_analytical, 3)
